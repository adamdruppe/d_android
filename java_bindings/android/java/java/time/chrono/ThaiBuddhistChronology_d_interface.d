module android.java.java.time.chrono.ThaiBuddhistChronology_d_interface;
...
import import8 = android.java.java.time.chrono.ThaiBuddhistEra_d_interface;
...
final class ThaiBuddhistChronology : IJavaObject {
	static immutable string[] _d_canCastTo = [
		"java/io/Serializable",
	];
	@Import string getId();
	@Import string getCalendarType();
	@Import import0.ThaiBuddhistDate date(import1.Era, int, int, int);
	@Import import0.ThaiBuddhistDate date(int, int, int);
	@Import import0.ThaiBuddhistDate dateYearDay(import1.Era, int, int);
	@Import import0.ThaiBuddhistDate dateYearDay(int, int);
	@Import import0.ThaiBuddhistDate dateEpochDay(long);
	@Import import0.ThaiBuddhistDate dateNow();
	@Import import0.ThaiBuddhistDate dateNow(import2.ZoneId);
	@Import import0.ThaiBuddhistDate dateNow(import3.Clock);
	@Import import0.ThaiBuddhistDate date(import4.TemporalAccessor);
	...
	@Import import8.ThaiBuddhistEra eraOf(int);
	@Import import9.List eras();
	@Import import10.ValueRange range(import11.ChronoField);
	@Import import0.ThaiBuddhistDate resolveDate(import12.Map, import13.ResolverStyle);
	...
	public static immutable string _javaParameterString = "Ljava/time/chrono/ThaiBuddhistChronology;";
}

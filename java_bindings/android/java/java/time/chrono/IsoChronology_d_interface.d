...
final class IsoChronology : IJavaObject {
	...
	@Import import15.ChronoLocalDate resolveDate(import10.Map, import11.ResolverStyle);
	@Import import16.ChronoPeriod period(int, int, int);
	@Import import1.Era eraOf(int);
	@Import import17.ChronoZonedDateTime zonedDateTime(import5.Instant, import6.ZoneId);
	@Import import17.ChronoZonedDateTime zonedDateTime(import2.TemporalAccessor);
	@Import import18.ChronoLocalDateTime localDateTime(import2.TemporalAccessor);
	@Import import15.ChronoLocalDate date(import2.TemporalAccessor);
	@Import import15.ChronoLocalDate dateNow(import7.Clock);
	@Import import15.ChronoLocalDate dateNow(import6.ZoneId);
	@Import import15.ChronoLocalDate dateNow();
	@Import import15.ChronoLocalDate dateEpochDay(long);
	@Import import15.ChronoLocalDate dateYearDay(int, int);
	@Import import15.ChronoLocalDate dateYearDay(import1.Era, int, int);

module android.java.java.time.chrono.HijrahDate_d_interface;
...
import import4 = android.java.java.time.chrono.HijrahChronology_d_interface;
...
import import0 = android.java.java.time.chrono.HijrahDate_d_interface;
...
import import5 = android.java.java.time.chrono.HijrahEra_d_interface;
...
final class HijrahDate : IJavaObject {
	...
	@Import static import0.HijrahDate now();
	@Import static import0.HijrahDate now(import1.ZoneId);
	@Import static import0.HijrahDate now(import2.Clock);
	@Import static import0.HijrahDate of(int, int, int);
	@Import static import0.HijrahDate from(import3.TemporalAccessor);
	@Import import4.HijrahChronology getChronology();
	@Import import5.HijrahEra getEra();
	...
	@Import @JavaName("with") import0.HijrahDate with_(import7.TemporalField, long);
	@Import @JavaName("with") import0.HijrahDate with_(import8.TemporalAdjuster);
	@Import import0.HijrahDate withVariant(import4.HijrahChronology);
	@Import import0.HijrahDate plus(import9.TemporalAmount);
	@Import import0.HijrahDate minus(import9.TemporalAmount);
	@Import long toEpochDay();
	@Import bool isLeapYear();
	@Import import0.HijrahDate plus(long, import10.TemporalUnit);
	@Import import0.HijrahDate minus(long, import10.TemporalUnit);

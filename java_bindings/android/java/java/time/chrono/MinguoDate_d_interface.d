...
import import4 = android.java.java.time.chrono.MinguoChronology_d_interface;
...
final class MinguoDate : IJavaObject {
	...
	@Import static import0.MinguoDate of(int, int, int);
	@Import static import0.MinguoDate from(import3.TemporalAccessor);
	@Import import4.MinguoChronology getChronology();
	@Import import5.MinguoEra getEra();
	@Import int lengthOfMonth();
	@Import import6.ValueRange range(import7.TemporalField);
	@Import long getLong(import7.TemporalField);
	@Import @JavaName("with") import0.MinguoDate with_(import7.TemporalField, long);
	@Import @JavaName("with") import0.MinguoDate with_(import8.TemporalAdjuster);
	@Import import0.MinguoDate plus(import9.TemporalAmount);
	@Import import0.MinguoDate minus(import9.TemporalAmount);
	@Import import0.MinguoDate plus(long, import10.TemporalUnit);
	@Import import0.MinguoDate minus(long, import10.TemporalUnit);

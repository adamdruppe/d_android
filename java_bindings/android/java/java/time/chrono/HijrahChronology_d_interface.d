module android.java.java.time.chrono.HijrahChronology_d_interface;
...
import import8 = android.java.java.time.chrono.HijrahEra_d_interface;
...
final class HijrahChronology : IJavaObject {
	static immutable string[] _d_canCastTo = [
		"java/io/Serializable",
	];
	@Import string getId();
	@Import string getCalendarType();
	@Import import0.HijrahDate date(import1.Era, int, int, int);
	@Import import0.HijrahDate date(int, int, int);
	@Import import0.HijrahDate dateYearDay(import1.Era, int, int);
	@Import import0.HijrahDate dateYearDay(int, int);
	@Import import0.HijrahDate dateEpochDay(long);
	@Import import0.HijrahDate dateNow();
	@Import import0.HijrahDate dateNow(import2.ZoneId);
	@Import import0.HijrahDate dateNow(import3.Clock);
	@Import import0.HijrahDate date(import4.TemporalAccessor);
	...
	@Import import8.HijrahEra eraOf(int);
	@Import import9.List eras();
	@Import import10.ValueRange range(import11.ChronoField);
	@Import import0.HijrahDate resolveDate(import12.Map, import13.ResolverStyle);

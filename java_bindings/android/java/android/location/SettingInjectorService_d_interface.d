...
final class SettingInjectorService : IJavaObject {
	...
	@Import static void refreshSettings(import2.Context);
	...
	@Import import2.Context getBaseContext();
	...
	@Import import2.Context getApplicationContext();
	...
	@Import bool moveSharedPreferencesFrom(import2.Context, string);
	...
	@Import bool moveDatabaseFrom(import2.Context, string);
	...
	@Import import2.Context createPackageContext(string, int);
	@Import import2.Context createContextForSplit(string);
	@Import import2.Context createConfigurationContext(import4.Configuration);
	@Import import2.Context createDisplayContext(import35.Display);
	@Import bool isRestricted();
	@Import import2.Context createDeviceProtectedStorageContext();

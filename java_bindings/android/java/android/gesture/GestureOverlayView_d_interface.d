...
import import55 = android.java.android.view.contentcapture.ContentCaptureSession_d_interface;
import import42 = android.java.android.view.View_OnClickListener_d_interface;
import import18 = android.java.java.util.Collection_d_interface;
import import58 = android.java.android.view.View_OnApplyWindowInsetsListener_d_interface;
import import57 = android.java.android.view.accessibility.AccessibilityNodeProvider_d_interface;
import import52 = android.java.android.view.autofill.AutofillValue_d_interface;
...
import import28 = android.java.android.view.ViewParent_d_interface;
import import22 = android.java.android.view.PointerIcon_d_interface;
...
import import17 = android.java.android.view.accessibility.AccessibilityEvent_d_interface;
...
import import16 = android.java.android.graphics.Rect_d_interface;
import import25 = android.java.android.view.ViewGroupOverlay_d_interface;
...
import import13 = android.java.android.view.View_d_interface;
import import26 = android.java.android.view.ViewGroup_OnHierarchyChangeListener_d_interface;
import import27 = android.java.android.animation.LayoutTransition_d_interface;
import import7 = android.java.android.gesture.GestureOverlayView_OnGesturingListener_d_interface;
import import1 = android.java.android.util.AttributeSet_d_interface;
import import37 = android.java.android.graphics.drawable.Drawable_d_interface;
import import21 = android.java.android.view.KeyEvent_d_interface;
...
import import30 = android.java.android.view.animation.LayoutAnimationController_d_interface;
import import24 = android.java.android.os.Bundle_d_interface;
import import54 = android.java.android.view.autofill.AutofillId_d_interface;
...
import import35 = android.java.java.util.Map_d_interface;
import import34 = android.java.android.view.ViewOverlay_d_interface;
import import69 = android.java.java.lang.Runnable_d_interface;
import import53 = android.java.android.util.SparseArray_d_interface;
...
import import56 = android.java.android.view.View_AccessibilityDelegate_d_interface;
...
import import32 = android.java.android.view.WindowInsets_d_interface;
...
import import29 = android.java.android.graphics.Point_d_interface;
...
import import40 = android.java.android.view.View_OnLayoutChangeListener_d_interface;
...
import import41 = android.java.android.view.View_OnAttachStateChangeListener_d_interface;
import import38 = android.java.android.view.View_OnScrollChangeListener_d_interface;
import import61 = android.java.android.view.inputmethod.InputConnection_d_interface;
import import33 = android.java.android.view.animation.Animation_AnimationListener_d_interface;
...
import import23 = android.java.android.view.ViewStructure_d_interface;
import import59 = android.java.java.util.List_d_interface;
import import39 = android.java.android.view.View_OnFocusChangeListener_d_interface;
import import31 = android.java.android.graphics.Region_d_interface;
...
final class GestureOverlayView : IJavaObject {
	...
	@Import void requestChildFocus(import13.View, import13.View);
	@Import void focusableViewAvailable(import13.View);
	@Import bool showContextMenuForChild(import13.View);
	@Import bool showContextMenuForChild(import13.View, float, float);
	@Import import14.ActionMode startActionModeForChild(import13.View, import15.ActionMode_Callback);
	@Import import14.ActionMode startActionModeForChild(import13.View, import15.ActionMode_Callback, int);
	@Import import13.View focusSearch(import13.View, int);
	@Import bool requestChildRectangleOnScreen(import13.View, import16.Rect, bool);
	@Import bool requestSendAccessibilityEvent(import13.View, import17.AccessibilityEvent);
	@Import bool onRequestSendAccessibilityEvent(import13.View, import17.AccessibilityEvent);
	@Import void childHasTransientStateChanged(import13.View, bool);
	@Import bool hasTransientState();
	@Import bool dispatchUnhandledMove(import13.View, int);
	@Import void clearChildFocus(import13.View);
	@Import void clearFocus();
	@Import import13.View getFocusedChild();
	@Import bool hasFocus();
	@Import import13.View findFocus();
	@Import void addFocusables(import2.ArrayList, int, int);
	...
	@Import void findViewsWithText(import2.ArrayList, import11.CharSequence, int);
	@Import void dispatchWindowFocusChanged(bool);
	@Import void addTouchables(import2.ArrayList);
	...
	@Import void recomputeViewAttributes(import13.View);
	@Import void bringChildToFront(import13.View);
	...
	@Import bool dispatchKeyEventPreIme(import21.KeyEvent);
	@Import bool dispatchKeyEvent(import21.KeyEvent);
	@Import bool dispatchKeyShortcutEvent(import21.KeyEvent);
	...
	@Import import22.PointerIcon onResolvePointerIcon(import9.MotionEvent, int);
	@Import void addChildrenForAccessibility(import2.ArrayList);
	@Import bool onInterceptHoverEvent(import9.MotionEvent);
	...
	@Import bool onInterceptTouchEvent(import9.MotionEvent);
	@Import bool requestFocus(int, import16.Rect);
	@Import bool restoreDefaultFocus();
	@Import void dispatchStartTemporaryDetach();
	@Import void dispatchFinishTemporaryDetach();
	@Import void dispatchProvideStructure(import23.ViewStructure);
	@Import void dispatchProvideAutofillStructure(import23.ViewStructure, int);
	@Import void notifySubtreeAccessibilityStateChanged(import13.View, import13.View, int);
	@Import bool onNestedPrePerformAccessibilityAction(import13.View, int, import24.Bundle);
	@Import import25.ViewGroupOverlay getOverlay();
	...
	@Import void addView(import13.View);
	@Import void addView(import13.View, int);
	@Import void addView(import13.View, int, int);
	@Import void addView(import13.View, import12.ViewGroup_LayoutParams);
	@Import void addView(import13.View, int, import12.ViewGroup_LayoutParams);
	@Import void updateViewLayout(import13.View, import12.ViewGroup_LayoutParams);
	@Import void setOnHierarchyChangeListener(import26.ViewGroup_OnHierarchyChangeListener);
	@Import void onViewAdded(import13.View);
	@Import void onViewRemoved(import13.View);
	@Import void removeView(import13.View);
	@Import void removeViewInLayout(import13.View);
	@Import void removeViewsInLayout(int, int);
	@Import void removeViewAt(int);
	@Import void removeViews(int, int);
	@Import void setLayoutTransition(import27.LayoutTransition);
	@Import import27.LayoutTransition getLayoutTransition();
	@Import void removeAllViews();
	@Import void removeAllViewsInLayout();
	@Import void onDescendantInvalidated(import13.View, import13.View);
	@Import void invalidateChild(import13.View, import16.Rect);
	@Import import28.ViewParent invalidateChildInParent(int, import16.Rect[]);
	@Import void offsetDescendantRectToMyCoords(import13.View, import16.Rect);
	@Import void offsetRectIntoDescendantCoords(import13.View, import16.Rect);
	@Import bool getChildVisibleRect(import13.View, import16.Rect, import29.Point);
	@Import void layout(int, int, int, int);
	@Import void startLayoutAnimation();
	@Import void scheduleLayoutAnimation();
	@Import void setLayoutAnimation(import30.LayoutAnimationController);
	@Import import30.LayoutAnimationController getLayoutAnimation();
	...
	@Import int indexOfChild(import13.View);
	@Import int getChildCount();
	@Import import13.View getChildAt(int);
	@Import static int getChildMeasureSpec(int, int, int);
	@Import void clearDisappearingChildren();
	@Import void startViewTransition(import13.View);
	@Import void endViewTransition(import13.View);
	@Import void suppressLayout(bool);
	@Import bool isLayoutSuppressed();
	@Import bool gatherTransparentRegion(import31.Region);
	@Import void requestTransparentRegion(import13.View);
	@Import import32.WindowInsets dispatchApplyWindowInsets(import32.WindowInsets);
	@Import import33.Animation_AnimationListener getLayoutAnimationListener();
	@Import void jumpDrawablesToCurrentState();
	@Import void setAddStatesFromChildren(bool);
	@Import bool addStatesFromChildren();
	@Import void childDrawableStateChanged(import13.View);
	@Import void setLayoutAnimationListener(import33.Animation_AnimationListener);
	@Import bool onStartNestedScroll(import13.View, import13.View, int);
	@Import void onNestedScrollAccepted(import13.View, import13.View, int);
	@Import void onStopNestedScroll(import13.View);
	@Import void onNestedScroll(import13.View, int, int, int, int);
	@Import void onNestedPreScroll(import13.View, int, int, int[]);
	@Import bool onNestedFling(import13.View, float, float, bool);
	@Import bool onNestedPreFling(import13.View, float, float);
	@Import int getNestedScrollAxes();
	@Import int[] getAttributeResolutionStack(int);
	@Import import35.Map getAttributeSourceResourceMap();
	@Import int getExplicitStyle();
	@Import void saveAttributeDataForStyleable(import0.Context, int, import1.AttributeSet, import36.TypedArray, int, int[]);
	...
	@Import void setVerticalScrollbarThumbDrawable(import37.Drawable);
	@Import void setVerticalScrollbarTrackDrawable(import37.Drawable);
	@Import void setHorizontalScrollbarThumbDrawable(import37.Drawable);
	@Import void setHorizontalScrollbarTrackDrawable(import37.Drawable);
	@Import import37.Drawable getVerticalScrollbarThumbDrawable();
	@Import import37.Drawable getVerticalScrollbarTrackDrawable();
	@Import import37.Drawable getHorizontalScrollbarThumbDrawable();
	@Import import37.Drawable getHorizontalScrollbarTrackDrawable();
	...
	@Import void setOnScrollChangeListener(import38.View_OnScrollChangeListener);
	@Import void setOnFocusChangeListener(import39.View_OnFocusChangeListener);
	@Import void addOnLayoutChangeListener(import40.View_OnLayoutChangeListener);
	@Import void removeOnLayoutChangeListener(import40.View_OnLayoutChangeListener);
	@Import void addOnAttachStateChangeListener(import41.View_OnAttachStateChangeListener);
	@Import void removeOnAttachStateChangeListener(import41.View_OnAttachStateChangeListener);
	@Import import39.View_OnFocusChangeListener getOnFocusChangeListener();
	@Import void setOnClickListener(import42.View_OnClickListener);
	...
	@Import bool requestRectangleOnScreen(import16.Rect);
	@Import bool requestRectangleOnScreen(import16.Rect, bool);
	@Import bool hasFocusable();
	@Import bool hasExplicitFocusable();
	@Import void setAccessibilityPaneTitle(import11.CharSequence);
	@Import import11.CharSequence getAccessibilityPaneTitle();
	@Import void sendAccessibilityEvent(int);
	@Import void announceForAccessibility(import11.CharSequence);
	@Import void sendAccessibilityEventUnchecked(import17.AccessibilityEvent);
	@Import bool dispatchPopulateAccessibilityEvent(import17.AccessibilityEvent);
	@Import void onPopulateAccessibilityEvent(import17.AccessibilityEvent);
	@Import void onInitializeAccessibilityEvent(import17.AccessibilityEvent);
	...
	@Import void onProvideStructure(import23.ViewStructure);
	@Import void onProvideAutofillStructure(import23.ViewStructure, int);
	@Import void onProvideVirtualStructure(import23.ViewStructure);
	@Import void onProvideAutofillVirtualStructure(import23.ViewStructure, int);
	@Import void autofill(import52.AutofillValue);
	@Import void autofill(import53.SparseArray);
	@Import import54.AutofillId getAutofillId();
	@Import void setAutofillId(import54.AutofillId);
	@Import int getAutofillType();
	@Import string[] getAutofillHints();
	@Import import52.AutofillValue getAutofillValue();
	@Import int getImportantForAutofill();
	@Import void setImportantForAutofill(int);
	@Import bool isImportantForAutofill();
	@Import void setContentCaptureSession(import55.ContentCaptureSession);
	@Import import55.ContentCaptureSession getContentCaptureSession();
	@Import void addExtraDataToAccessibilityNodeInfo(import51.AccessibilityNodeInfo, string, import24.Bundle);
	@Import bool isVisibleToUserForAutofill(int);
	@Import import56.View_AccessibilityDelegate getAccessibilityDelegate();
	@Import void setAccessibilityDelegate(import56.View_AccessibilityDelegate);
	@Import import57.AccessibilityNodeProvider getAccessibilityNodeProvider();
	@Import import11.CharSequence getContentDescription();
	@Import void setContentDescription(import11.CharSequence);
	...
	@Import bool isShown();
	@Import import32.WindowInsets onApplyWindowInsets(import32.WindowInsets);
	@Import void setOnApplyWindowInsetsListener(import58.View_OnApplyWindowInsetsListener);
	@Import void setSystemGestureExclusionRects(import59.List);
	@Import import59.List getSystemGestureExclusionRects();
	@Import void getLocationInSurface(int[]);
	@Import import32.WindowInsets getRootWindowInsets();
	@Import import32.WindowInsets computeSystemWindowInsets(import32.WindowInsets, import16.Rect);
	...
	@Import import13.View focusSearch(int);
	...
	@Import import13.View keyboardNavigationClusterSearch(import13.View, int);
	@Import void setDefaultFocusHighlightEnabled(bool);
	@Import bool getDefaultFocusHighlightEnabled();
	@Import import2.ArrayList getFocusables(int);
	@Import void addFocusables(import2.ArrayList, int);
	@Import import2.ArrayList getTouchables();
	...
	@Import import28.ViewParent getParentForAccessibility();
	...
	@Import void getWindowVisibleDisplayFrame(import16.Rect);
	@Import bool isInTouchMode();
	@Import import0.Context getContext();
	@Import bool onKeyPreIme(int, import21.KeyEvent);
	@Import bool onKeyDown(int, import21.KeyEvent);
	@Import bool onKeyLongPress(int, import21.KeyEvent);
	@Import bool onKeyUp(int, import21.KeyEvent);
	@Import bool onKeyMultiple(int, int, import21.KeyEvent);
	@Import bool onKeyShortcut(int, import21.KeyEvent);
	@Import bool onCheckIsTextEditor();
	@Import import61.InputConnection onCreateInputConnection(import62.EditorInfo);
	@Import bool checkInputConnectionProxy(import13.View);
	...
	@Import import28.ViewParent getParent();
	...
	@Import void getDrawingRect(import16.Rect);
	...
	@Import void getHitRect(import16.Rect);
	@Import void getFocusedRect(import16.Rect);
	@Import bool getGlobalVisibleRect(import16.Rect, import29.Point);
	@Import bool getGlobalVisibleRect(import16.Rect);
	@Import bool getLocalVisibleRect(import16.Rect);
	@Import void offsetTopAndBottom(int);
	@Import void offsetLeftAndRight(int);
	@Import import12.ViewGroup_LayoutParams getLayoutParams();
	@Import void setLayoutParams(import12.ViewGroup_LayoutParams);
	@Import void scrollTo(int, int);
	@Import void scrollBy(int, int);
	@Import void invalidate(import16.Rect);
	...
	@Import void saveHierarchyState(import53.SparseArray);
	@Import void restoreHierarchyState(import53.SparseArray);
	...
	@Import void setClipBounds(import16.Rect);
	@Import import16.Rect getClipBounds();
	@Import bool getClipBounds(import16.Rect);
	...
	@Import void invalidateDrawable(import37.Drawable);
	@Import void scheduleDrawable(import37.Drawable, import69.Runnable, long);
	@Import void unscheduleDrawable(import37.Drawable, import69.Runnable);
	@Import void unscheduleDrawable(import37.Drawable);
	...
	@Import void setBackground(import37.Drawable);
	@Import void setBackgroundDrawable(import37.Drawable);
	@Import import37.Drawable getBackground();
	...
	@Import import37.Drawable getForeground();
	@Import void setForeground(import37.Drawable);
	...
	@Import import13.View getRootView();
	...
	@Import import13.View findViewById(int);
	@Import import13.View requireViewById(int);
	@Import import13.View findViewWithTag(IJavaObject);
	...
	@Import static import13.View inflate(import0.Context, int, import84.ViewGroup);
	...
	@Import void setPointerIcon(import22.PointerIcon);
	@Import import22.PointerIcon getPointerIcon();
	...
	@Import void setTooltipText(import11.CharSequence);
	@Import import11.CharSequence getTooltipText();

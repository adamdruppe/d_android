module android.java.android.graphics.drawable.shapes.OvalShape_d_interface;
...
import import3 = android.java.android.graphics.drawable.shapes.OvalShape_d_interface;

final class OvalShape : IJavaObject {
	@Import void draw(import0.Canvas, import1.Paint);
	@Import void getOutline(import2.Outline);
	@Import import3.OvalShape clone();
	@Import import4.RectShape clone();
	@Import import5.Shape clone();
	@Import IJavaObject clone();
	mixin IJavaObjectImplementation!(false);
	public static immutable string _javaParameterString = "Landroid/graphics/drawable/shapes/OvalShape";
}

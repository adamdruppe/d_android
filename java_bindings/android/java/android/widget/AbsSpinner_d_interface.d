...
import import9 = android.java.android.widget.AdapterView_OnItemLongClickListener_d_interface;
import import19 = android.java.java.util.Collection_d_interface;
...
import import10 = android.java.android.widget.AdapterView_OnItemSelectedListener_d_interface;
import import22 = android.java.android.view.KeyEvent_d_interface;
...
import import8 = android.java.android.widget.AdapterView_OnItemClickListener_d_interface;
import import61 = android.java.android.view.inputmethod.EditorInfo_d_interface;
import import21 = android.java.android.view.DragEvent_d_interface;
...
import import23 = android.java.android.view.MotionEvent_d_interface;
import import37 = android.java.android.content.res.TypedArray_d_interface;
import import13 = android.java.android.view.ViewStructure_d_interface;
...
import import12 = android.java.android.view.View_OnClickListener_d_interface;
...
final class AbsSpinner : IJavaObject {
	...
	@Import void setOnItemClickListener(import8.AdapterView_OnItemClickListener);
	@Import import8.AdapterView_OnItemClickListener getOnItemClickListener();
	@Import bool performItemClick(import3.View, int, long);
	@Import void setOnItemLongClickListener(import9.AdapterView_OnItemLongClickListener);
	@Import import9.AdapterView_OnItemLongClickListener getOnItemLongClickListener();
	@Import void setOnItemSelectedListener(import10.AdapterView_OnItemSelectedListener);
	@Import import10.AdapterView_OnItemSelectedListener getOnItemSelectedListener();
	@Import void addView(import3.View);
	@Import void addView(import3.View, int);
	@Import void addView(import3.View, import11.ViewGroup_LayoutParams);
	@Import void addView(import3.View, int, import11.ViewGroup_LayoutParams);
	...
	@Import void setOnClickListener(import12.View_OnClickListener);
	@Import void onProvideAutofillStructure(import13.ViewStructure, int);
	...
	@Import import14.ActionMode startActionModeForChild(import3.View, import15.ActionMode_Callback);
	@Import import14.ActionMode startActionModeForChild(import3.View, import15.ActionMode_Callback, int);
	@Import import3.View focusSearch(import3.View, int);
	@Import bool requestChildRectangleOnScreen(import3.View, import16.Rect, bool);
	@Import bool requestSendAccessibilityEvent(import3.View, import17.AccessibilityEvent);
	@Import bool onRequestSendAccessibilityEvent(import3.View, import17.AccessibilityEvent);
	...
	@Import void addFocusables(import18.ArrayList, int, int);
	@Import void addKeyboardNavigationClusters(import19.Collection, int);
	@Import void setTouchscreenBlocksFocus(bool);
	@Import bool getTouchscreenBlocksFocus();
	@Import void findViewsWithText(import18.ArrayList, import5.CharSequence, int);
	@Import void dispatchWindowFocusChanged(bool);
	@Import void addTouchables(import18.ArrayList);
	@Import void dispatchDisplayHint(int);
	@Import void dispatchWindowVisibilityChanged(int);
	@Import void dispatchConfigurationChanged(import20.Configuration);
	@Import void recomputeViewAttributes(import3.View);
	@Import void bringChildToFront(import3.View);
	@Import bool dispatchDragEvent(import21.DragEvent);
	@Import void dispatchWindowSystemUiVisiblityChanged(int);
	@Import void dispatchSystemUiVisibilityChanged(int);
	@Import bool dispatchKeyEventPreIme(import22.KeyEvent);
	@Import bool dispatchKeyEvent(import22.KeyEvent);
	@Import bool dispatchKeyShortcutEvent(import22.KeyEvent);
	@Import bool dispatchTrackballEvent(import23.MotionEvent);
	@Import bool dispatchCapturedPointerEvent(import23.MotionEvent);
	@Import void dispatchPointerCaptureChanged(bool);
	@Import import24.PointerIcon onResolvePointerIcon(import23.MotionEvent, int);
	@Import void addChildrenForAccessibility(import18.ArrayList);
	@Import bool onInterceptHoverEvent(import23.MotionEvent);
	@Import bool dispatchTouchEvent(import23.MotionEvent);
	...
	@Import bool onInterceptTouchEvent(import23.MotionEvent);
	...
	@Import void dispatchProvideStructure(import13.ViewStructure);
	@Import void dispatchProvideAutofillStructure(import13.ViewStructure, int);
	@Import void notifySubtreeAccessibilityStateChanged(import3.View, import3.View, int);
	@Import bool onNestedPrePerformAccessibilityAction(import3.View, int, import25.Bundle);
	...
	@Import void updateViewLayout(import3.View, import11.ViewGroup_LayoutParams);
	...
	@Import void invalidateChild(import3.View, import16.Rect);
	@Import import29.ViewParent invalidateChildInParent(int, import16.Rect[]);
	@Import void offsetDescendantRectToMyCoords(import3.View, import16.Rect);
	@Import void offsetRectIntoDescendantCoords(import3.View, import16.Rect);
	@Import bool getChildVisibleRect(import3.View, import16.Rect, import30.Point);
	...
	@Import import11.ViewGroup_LayoutParams generateLayoutParams(import1.AttributeSet);
	...
	@Import void onProvideStructure(import13.ViewStructure);
	@Import void onProvideVirtualStructure(import13.ViewStructure);
	@Import void onProvideAutofillVirtualStructure(import13.ViewStructure, int);
	...
	@Import import33.WindowInsets computeSystemWindowInsets(import33.WindowInsets, import16.Rect);
	...
	@Import import18.ArrayList getFocusables(int);
	@Import void addFocusables(import18.ArrayList, int);
	@Import import18.ArrayList getTouchables();
	...
	@Import bool onFilterTouchEventForSecurity(import23.MotionEvent);
	@Import bool dispatchGenericMotionEvent(import23.MotionEvent);
	...
	@Import bool onKeyPreIme(int, import22.KeyEvent);
	@Import bool onKeyDown(int, import22.KeyEvent);
	@Import bool onKeyLongPress(int, import22.KeyEvent);
	@Import bool onKeyUp(int, import22.KeyEvent);
	@Import bool onKeyMultiple(int, int, import22.KeyEvent);
	@Import bool onKeyShortcut(int, import22.KeyEvent);
	...
	@Import bool onTrackballEvent(import23.MotionEvent);
	@Import bool onGenericMotionEvent(import23.MotionEvent);
	@Import bool onHoverEvent(import23.MotionEvent);
	@Import bool isHovered();
	@Import void setHovered(bool);
	@Import void onHoverChanged(bool);
	@Import bool onTouchEvent(import23.MotionEvent);
	...
	@Import void requestUnbufferedDispatch(import23.MotionEvent);
	...
	@Import bool getGlobalVisibleRect(import16.Rect, import30.Point);
	...
	@Import bool onDragEvent(import21.DragEvent);
	@Import static import3.View inflate(import0.Context, int, import84.ViewGroup);
	...
	@Import bool onCapturedPointerEvent(import23.MotionEvent);

...
import import21 = android.java.android.view.ViewGroup_LayoutParams_d_interface;
...
final class SlidingDrawer : IJavaObject {
	...
	@Import void requestChildFocus(import7.View, import7.View);
	@Import void focusableViewAvailable(import7.View);
	@Import bool showContextMenuForChild(import7.View);
	@Import bool showContextMenuForChild(import7.View, float, float);
	@Import import8.ActionMode startActionModeForChild(import7.View, import9.ActionMode_Callback);
	@Import import8.ActionMode startActionModeForChild(import7.View, import9.ActionMode_Callback, int);
	@Import import7.View focusSearch(import7.View, int);
	@Import bool requestChildRectangleOnScreen(import7.View, import10.Rect, bool);
	@Import bool requestSendAccessibilityEvent(import7.View, import11.AccessibilityEvent);
	@Import bool onRequestSendAccessibilityEvent(import7.View, import11.AccessibilityEvent);
	@Import void childHasTransientStateChanged(import7.View, bool);
	@Import bool hasTransientState();
	@Import bool dispatchUnhandledMove(import7.View, int);
	@Import void clearChildFocus(import7.View);
	@Import void clearFocus();
	@Import import7.View getFocusedChild();
	@Import bool hasFocus();
	@Import import7.View findFocus();
	...
	@Import void findViewsWithText(import12.ArrayList, import3.CharSequence, int);
	...
	@Import void recomputeViewAttributes(import7.View);
	@Import void bringChildToFront(import7.View);
	...
	@Import import17.PointerIcon onResolvePointerIcon(import2.MotionEvent, int);
	...
	@Import void notifySubtreeAccessibilityStateChanged(import7.View, import7.View, int);
	@Import bool onNestedPrePerformAccessibilityAction(import7.View, int, import19.Bundle);
	...
	@Import void addView(import7.View);
	@Import void addView(import7.View, int);
	@Import void addView(import7.View, int, int);
	@Import void addView(import7.View, import21.ViewGroup_LayoutParams);
	@Import void addView(import7.View, int, import21.ViewGroup_LayoutParams);
	@Import void updateViewLayout(import7.View, import21.ViewGroup_LayoutParams);
	@Import void setOnHierarchyChangeListener(import22.ViewGroup_OnHierarchyChangeListener);
	@Import void onViewAdded(import7.View);
	@Import void onViewRemoved(import7.View);
	@Import void removeView(import7.View);
	@Import void removeViewInLayout(import7.View);
	...
	@Import void onDescendantInvalidated(import7.View, import7.View);
	@Import void invalidateChild(import7.View, import10.Rect);
	@Import import24.ViewParent invalidateChildInParent(int, import10.Rect[]);
	@Import void offsetDescendantRectToMyCoords(import7.View, import10.Rect);
	@Import void offsetRectIntoDescendantCoords(import7.View, import10.Rect);
	@Import bool getChildVisibleRect(import7.View, import10.Rect, import25.Point);
	...
	@Import import21.ViewGroup_LayoutParams generateLayoutParams(import1.AttributeSet);
	@Import int indexOfChild(import7.View);
	@Import int getChildCount();
	@Import import7.View getChildAt(int);
	@Import static int getChildMeasureSpec(int, int, int);
	@Import void clearDisappearingChildren();
	@Import void startViewTransition(import7.View);
	@Import void endViewTransition(import7.View);
	@Import void suppressLayout(bool);
	@Import bool isLayoutSuppressed();
	@Import bool gatherTransparentRegion(import27.Region);
	@Import void requestTransparentRegion(import7.View);
	...
	@Import void childDrawableStateChanged(import7.View);
	@Import void setLayoutAnimationListener(import29.Animation_AnimationListener);
	@Import bool shouldDelayChildPressedState();
	@Import bool onStartNestedScroll(import7.View, import7.View, int);
	@Import void onNestedScrollAccepted(import7.View, import7.View, int);
	@Import void onStopNestedScroll(import7.View);
	@Import void onNestedScroll(import7.View, int, int, int, int);
	@Import void onNestedPreScroll(import7.View, int, int, int[]);
	@Import bool onNestedFling(import7.View, float, float, bool);
	@Import bool onNestedPreFling(import7.View, float, float);
	...
	@Import void addExtraDataToAccessibilityNodeInfo(import47.AccessibilityNodeInfo, string, import19.Bundle);
	...
	@Import import7.View focusSearch(int);
	...
	@Import import7.View keyboardNavigationClusterSearch(import7.View, int);
	...
	@Import bool checkInputConnectionProxy(import7.View);
	...
	@Import import21.ViewGroup_LayoutParams getLayoutParams();
	@Import void setLayoutParams(import21.ViewGroup_LayoutParams);
	...
	@Import import7.View getRootView();
	...
	@Import import7.View findViewWithTag(IJavaObject);
	...
	@Import static import7.View inflate(import0.Context, int, import81.ViewGroup);

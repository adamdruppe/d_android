...
import import10 = android.java.android.graphics.Matrix_d_interface;
...
import import9 = android.java.android.widget.ImageView_ScaleType_d_interface;
...
final class ImageView : IJavaObject {
	...
	@Import void setImageTintBlendMode(import7.BlendMode);
	@Import import6.PorterDuff_Mode getImageTintMode();
	@Import import7.BlendMode getImageTintBlendMode();
	@Import void setImageBitmap(import8.Bitmap);
	@Import void setImageState(int, bool[]);
	@Import void setSelected(bool);
	@Import void setImageLevel(int);
	@Import void setScaleType(import9.ImageView_ScaleType);
	@Import import9.ImageView_ScaleType getScaleType();
	@Import import10.Matrix getImageMatrix();
	@Import void setImageMatrix(import10.Matrix);
	...
	@Import void animateTransform(import10.Matrix);
	...
	@Import void findViewsWithText(import45.ArrayList, import12.CharSequence, int);
	...
	@Import import10.Matrix getMatrix();
	...
	@Import void setAnimationMatrix(import10.Matrix);
	@Import import10.Matrix getAnimationMatrix();
	...
	@Import bool getGlobalVisibleRect(import30.Rect, import58.Point);
	...
	@Import import8.Bitmap getDrawingCache();
	@Import import8.Bitmap getDrawingCache(bool);
	...
	@Import void scheduleDrawable(import2.Drawable, import61.Runnable, long);
	@Import void unscheduleDrawable(import2.Drawable, import61.Runnable);
	...
	@Import void transformMatrixToGlobal(import10.Matrix);
	@Import void transformMatrixToLocal(import10.Matrix);
	...
	@Import static import41.View inflate(import0.Context, int, import75.ViewGroup);

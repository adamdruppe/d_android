...
import import33 = android.java.android.graphics.Region_d_interface;
...
import import27 = android.java.android.view.ViewGroupOverlay_d_interface;
...
import import15 = android.java.android.view.View_d_interface;
...
import import37 = android.java.java.util.Map_d_interface;
import import36 = android.java.android.view.ViewOverlay_d_interface;
...
import import22 = android.java.android.view.DragEvent_d_interface;
...
import import14 = android.java.android.view.ViewGroup_LayoutParams_d_interface;
...
import import13 = android.java.android.widget.LinearLayout_LayoutParams_d_interface;
...
import import35 = android.java.android.view.animation.Animation_AnimationListener_d_interface;
...
final class SearchView : IJavaObject {
	...
	@Import bool isIconifiedByDefault();
	...
	@Import import12.Drawable getDividerDrawable();
	@Import void setDividerDrawable(import12.Drawable);
	...
	@Import import13.LinearLayout_LayoutParams generateLayoutParams(import1.AttributeSet);
	@Import int getDescendantFocusability();
	@Import void setDescendantFocusability(int);
	@Import void requestChildFocus(import15.View, import15.View);
	@Import void focusableViewAvailable(import15.View);
	@Import bool showContextMenuForChild(import15.View);
	@Import bool showContextMenuForChild(import15.View, float, float);
	@Import import16.ActionMode startActionModeForChild(import15.View, import17.ActionMode_Callback);
	@Import import16.ActionMode startActionModeForChild(import15.View, import17.ActionMode_Callback, int);
	@Import import15.View focusSearch(import15.View, int);
	@Import bool requestChildRectangleOnScreen(import15.View, import3.Rect, bool);
	@Import bool requestSendAccessibilityEvent(import15.View, import18.AccessibilityEvent);
	@Import bool onRequestSendAccessibilityEvent(import15.View, import18.AccessibilityEvent);
	@Import void childHasTransientStateChanged(import15.View, bool);
	@Import bool hasTransientState();
	@Import bool dispatchUnhandledMove(import15.View, int);
	@Import void clearChildFocus(import15.View);
	@Import import15.View getFocusedChild();
	@Import bool hasFocus();
	@Import import15.View findFocus();
	...
	@Import void findViewsWithText(import19.ArrayList, import9.CharSequence, int);
	...
	@Import void dispatchConfigurationChanged(import21.Configuration);
	@Import void recomputeViewAttributes(import15.View);
	@Import void bringChildToFront(import15.View);
	@Import bool dispatchDragEvent(import22.DragEvent);
	@Import void dispatchWindowSystemUiVisiblityChanged(int);
	@Import void dispatchSystemUiVisibilityChanged(int);
	@Import bool dispatchKeyEventPreIme(import11.KeyEvent);
	...
	@Import void notifySubtreeAccessibilityStateChanged(import15.View, import15.View, int);
	@Import bool onNestedPrePerformAccessibilityAction(import15.View, int, import26.Bundle);
	@Import import27.ViewGroupOverlay getOverlay();
	...
	@Import void addView(import15.View);
	@Import void addView(import15.View, int);
	@Import void addView(import15.View, int, int);
	@Import void addView(import15.View, import14.ViewGroup_LayoutParams);
	@Import void addView(import15.View, int, import14.ViewGroup_LayoutParams);
	@Import void updateViewLayout(import15.View, import14.ViewGroup_LayoutParams);
	@Import void setOnHierarchyChangeListener(import28.ViewGroup_OnHierarchyChangeListener);
	@Import void onViewAdded(import15.View);
	@Import void onViewRemoved(import15.View);
	@Import void removeView(import15.View);
	@Import void removeViewInLayout(import15.View);
	...
	@Import void onDescendantInvalidated(import15.View, import15.View);
	@Import void invalidateChild(import15.View, import3.Rect);
	@Import import30.ViewParent invalidateChildInParent(int, import3.Rect[]);
	@Import void offsetDescendantRectToMyCoords(import15.View, import3.Rect);
	@Import void offsetRectIntoDescendantCoords(import15.View, import3.Rect);
	@Import bool getChildVisibleRect(import15.View, import3.Rect, import31.Point);
	...
	@Import int indexOfChild(import15.View);
	@Import int getChildCount();
	@Import import15.View getChildAt(int);
	@Import static int getChildMeasureSpec(int, int, int);
	@Import void clearDisappearingChildren();
	@Import void startViewTransition(import15.View);
	@Import void endViewTransition(import15.View);
	@Import void suppressLayout(bool);
	@Import bool isLayoutSuppressed();
	@Import bool gatherTransparentRegion(import33.Region);
	@Import void requestTransparentRegion(import15.View);
	@Import import34.WindowInsets dispatchApplyWindowInsets(import34.WindowInsets);
	@Import import35.Animation_AnimationListener getLayoutAnimationListener();
	@Import void jumpDrawablesToCurrentState();
	@Import void setAddStatesFromChildren(bool);
	@Import bool addStatesFromChildren();
	@Import void childDrawableStateChanged(import15.View);
	@Import void setLayoutAnimationListener(import35.Animation_AnimationListener);
	@Import bool onStartNestedScroll(import15.View, import15.View, int);
	@Import void onNestedScrollAccepted(import15.View, import15.View, int);
	@Import void onStopNestedScroll(import15.View);
	@Import void onNestedScroll(import15.View, int, int, int, int);
	@Import void onNestedPreScroll(import15.View, int, int, int[]);
	@Import bool onNestedFling(import15.View, float, float, bool);
	@Import bool onNestedPreFling(import15.View, float, float);
	@Import int getNestedScrollAxes();
	@Import int[] getAttributeResolutionStack(int);
	@Import import37.Map getAttributeSourceResourceMap();
	@Import int getExplicitStyle();
	@Import void saveAttributeDataForStyleable(import0.Context, int, import1.AttributeSet, import38.TypedArray, int, int[]);
	...
	@Import bool requestRectangleOnScreen(import3.Rect);
	@Import bool requestRectangleOnScreen(import3.Rect, bool);
	...
	@Import void addExtraDataToAccessibilityNodeInfo(import50.AccessibilityNodeInfo, string, import26.Bundle);
	...
	@Import import34.WindowInsets computeSystemWindowInsets(import34.WindowInsets, import3.Rect);
	...
	@Import import15.View focusSearch(int);
	...
	@Import import15.View keyboardNavigationClusterSearch(import15.View, int);
	...
	@Import bool dispatchNestedPrePerformAccessibilityAction(int, import26.Bundle);
	@Import bool performAccessibilityAction(int, import26.Bundle);
	...
	@Import void getWindowVisibleDisplayFrame(import3.Rect);
	@Import bool isInTouchMode();
	@Import import0.Context getContext();
	@Import bool onKeyPreIme(int, import11.KeyEvent);
	...
	@Import bool checkInputConnectionProxy(import15.View);
	...
	@Import void getDrawingRect(import3.Rect);
	...
	@Import void getHitRect(import3.Rect);
	@Import void getFocusedRect(import3.Rect);
	@Import bool getGlobalVisibleRect(import3.Rect, import31.Point);
	@Import bool getGlobalVisibleRect(import3.Rect);
	@Import bool getLocalVisibleRect(import3.Rect);
	@Import void offsetTopAndBottom(int);
	@Import void offsetLeftAndRight(int);
	@Import import14.ViewGroup_LayoutParams getLayoutParams();
	@Import void setLayoutParams(import14.ViewGroup_LayoutParams);
	@Import void scrollTo(int, int);
	@Import void scrollBy(int, int);
	@Import void invalidate(import3.Rect);
	...
	@Import void setClipBounds(import3.Rect);
	@Import import3.Rect getClipBounds();
	@Import bool getClipBounds(import3.Rect);
	...
	@Import void scheduleDrawable(import12.Drawable, import68.Runnable, long);
	@Import void unscheduleDrawable(import12.Drawable, import68.Runnable);
	...
	@Import import15.View getRootView();
	...
	@Import import15.View findViewById(int);
	@Import import15.View requireViewById(int);
	@Import import15.View findViewWithTag(IJavaObject);
	...
	@Import bool onDragEvent(import22.DragEvent);
	@Import static import15.View inflate(import0.Context, int, import84.ViewGroup);

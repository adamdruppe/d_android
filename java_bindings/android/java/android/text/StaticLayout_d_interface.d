module android.java.android.text.StaticLayout_d_interface;
...
final class StaticLayout : IJavaObject {
	static immutable string[] _d_canCastTo = [
	];
	@Import this(import0.CharSequence, import1.TextPaint, int, import2.Layout_Alignment, float, float, bool);
	@Import this(import0.CharSequence, int, int, import1.TextPaint, int, import2.Layout_Alignment, float, float, bool);
	@Import this(import0.CharSequence, int, int, import1.TextPaint, int, import2.Layout_Alignment, float, float, bool, import3.TextUtils_TruncateAt, int);

module android.java.android.view.textclassifier.TextClassifierEvent_TextLinkifyEvent_Builder_d_interface;
...
import import0 = android.java.android.view.textclassifier.TextClassifierEvent_TextLinkifyEvent_d_interface;
import import4 = android.java.android.os.Bundle_d_interface;

@JavaName("TextClassifierEvent$TextLinkifyEvent$Builder")
final class TextClassifierEvent_TextLinkifyEvent_Builder : IJavaObject {
	static immutable string[] _d_canCastTo = [
	];
	@Import this(int);
	@Import import0.TextClassifierEvent_TextLinkifyEvent build();
	...
	public static immutable string _javaParameterString = "Landroid/view/textclassifier/TextClassifierEvent$TextLinkifyEvent$Builder;";
}

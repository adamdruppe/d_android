module android.java.android.view.textclassifier.TextClassifierEvent_LanguageDetectionEvent_Builder_d_interface;
...
import import0 = android.java.android.view.textclassifier.TextClassifierEvent_LanguageDetectionEvent_d_interface;
...
@JavaName("TextClassifierEvent$LanguageDetectionEvent$Builder")
final class TextClassifierEvent_LanguageDetectionEvent_Builder : IJavaObject {
	static immutable string[] _d_canCastTo = [
	];
	@Import this(int);
	@Import import0.TextClassifierEvent_LanguageDetectionEvent build();
	...
	public static immutable string _javaParameterString = "Landroid/view/textclassifier/TextClassifierEvent$LanguageDetectionEvent$Builder;";
}

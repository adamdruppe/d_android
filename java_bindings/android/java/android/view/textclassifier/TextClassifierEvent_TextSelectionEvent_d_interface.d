module android.java.android.view.textclassifier.TextClassifierEvent_TextSelectionEvent_d_interface;
...
@JavaName("TextClassifierEvent$TextSelectionEvent")
final class TextClassifierEvent_TextSelectionEvent : IJavaObject {
	static immutable string[] _d_canCastTo = [
		"android/os/Parcelable",
	];
	@Import void writeToParcel(import0.Parcel, int);
	@Import int getRelativeWordStartIndex();
	@Import int getRelativeWordEndIndex();
	@Import int getRelativeSuggestedWordStartIndex();
	@Import int getRelativeSuggestedWordEndIndex();
	...
	public static immutable string _javaParameterString = "Landroid/view/textclassifier/TextClassifierEvent$TextSelectionEvent;";
}

...
@JavaName("PropertyReader$PropertyTypeMismatchException")
final class PropertyReader_PropertyTypeMismatchException : IJavaObject {
	static immutable string[] _d_canCastTo = [
	];
	@Import this(int, string, string, string);
	...
	public static immutable string _javaParameterString = "Landroid/view/inspector/PropertyReader$PropertyTypeMismatchException;";
}

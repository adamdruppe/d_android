...
import import30 = android.java.android.widget.Toolbar_d_interface;
import import8 = android.java.android.view.WindowManager_d_interface;
...
import import9 = android.java.android.view.Window_d_interface;
...
import import25 = android.java.android.app.FragmentManager_d_interface;
import import78 = android.java.android.os.UserHandle_d_interface;
import import29 = android.java.android.app.ActionBar_d_interface;
...
import import10 = android.java.android.app.LoaderManager_d_interface;
...
import import7 = android.java.android.app.Activity_d_interface;
import import41 = android.java.android.graphics.drawable.Drawable_d_interface;
import import34 = android.java.android.view.KeyEvent_d_interface;
...
import import24 = android.java.android.app.PictureInPictureParams_d_interface;
import import50 = android.java.java.lang.Runnable_d_interface;
import import20 = android.java.java.util.function_.Consumer_d_interface;
import import38 = android.java.android.view.MenuItem_d_interface;
...
import import27 = android.java.android.database.Cursor_d_interface;
...
import import26 = android.java.android.app.Fragment_d_interface;
...
import import36 = android.java.android.view.WindowManager_LayoutParams_d_interface;
import import75 = android.java.java.io.InputStream_d_interface;
import import19 = android.java.android.os.CancellationSignal_d_interface;
...
import import23 = android.java.android.content.res.Configuration_d_interface;
import import31 = android.java.android.view.ViewGroup_LayoutParams_d_interface;
import import33 = android.java.android.transition.Scene_d_interface;
import import42 = android.java.android.view.LayoutInflater_d_interface;
import import39 = android.java.android.app.TaskStackBuilder_d_interface;
...
import import28 = android.java.android.net.Uri_d_interface;
...
import import18 = android.java.android.app.assist.AssistContent_d_interface;
...
import import32 = android.java.android.transition.TransitionManager_d_interface;
import import35 = android.java.android.view.MotionEvent_d_interface;
...
import import21 = android.java.java.util.List_d_interface;
...
final class ExpandableListActivity : IJavaObject {
	...
	@Import void setIntent(import5.Intent);
	@Import import6.Application getApplication();
	@Import bool isChild();
	@Import import7.Activity getParent();
	@Import import8.WindowManager getWindowManager();
	@Import import9.Window getWindow();
	@Import import10.LoaderManager getLoaderManager();
	...
	@Import import17.CharSequence onCreateDescription();
	@Import void onProvideAssistData(import12.Bundle);
	@Import void onProvideAssistContent(import18.AssistContent);
	@Import void onGetDirectActions(import19.CancellationSignal, import20.Consumer);
	@Import void onPerformDirectAction(string, import12.Bundle, import19.CancellationSignal, import20.Consumer);
	@Import void requestShowKeyboardShortcuts();
	@Import void dismissKeyboardShortcutsHelper();
	@Import void onProvideKeyboardShortcuts(import21.List, import22.Menu, int);
	@Import bool showAssist(import12.Bundle);
	@Import void reportFullyDrawn();
	@Import void onMultiWindowModeChanged(bool, import23.Configuration);
	@Import void onMultiWindowModeChanged(bool);
	@Import bool isInMultiWindowMode();
	@Import void onPictureInPictureModeChanged(bool, import23.Configuration);
	@Import void onPictureInPictureModeChanged(bool);
	@Import bool isInPictureInPictureMode();
	@Import void enterPictureInPictureMode();
	@Import bool enterPictureInPictureMode(import24.PictureInPictureParams);
	@Import void setPictureInPictureParams(import24.PictureInPictureParams);
	@Import int getMaxNumPictureInPictureActions();
	@Import void onConfigurationChanged(import23.Configuration);
	...
	@Import import25.FragmentManager getFragmentManager();
	@Import void onAttachFragment(import26.Fragment);
	@Import import27.Cursor managedQuery(import28.Uri, string, string, string, string[][]);
	@Import void startManagingCursor(import27.Cursor);
	@Import void stopManagingCursor(import27.Cursor);
	@Import import1.View findViewById(int);
	@Import import1.View requireViewById(int);
	@Import import29.ActionBar getActionBar();
	@Import void setActionBar(import30.Toolbar);
	@Import void setContentView(int);
	@Import void setContentView(import1.View);
	@Import void setContentView(import1.View, import31.ViewGroup_LayoutParams);
	@Import void addContentView(import1.View, import31.ViewGroup_LayoutParams);
	@Import import32.TransitionManager getContentTransitionManager();
	@Import void setContentTransitionManager(import32.TransitionManager);
	@Import import33.Scene getContentScene();
	@Import void setFinishOnTouchOutside(bool);
	@Import void setDefaultKeyMode(int);
	@Import bool onKeyDown(int, import34.KeyEvent);
	@Import bool onKeyLongPress(int, import34.KeyEvent);
	@Import bool onKeyUp(int, import34.KeyEvent);
	@Import bool onKeyMultiple(int, int, import34.KeyEvent);
	@Import void onBackPressed();
	@Import bool onKeyShortcut(int, import34.KeyEvent);
	@Import bool onTouchEvent(import35.MotionEvent);
	@Import bool onTrackballEvent(import35.MotionEvent);
	@Import bool onGenericMotionEvent(import35.MotionEvent);
	@Import void onUserInteraction();
	@Import void onWindowAttributesChanged(import36.WindowManager_LayoutParams);
	...
	@Import bool dispatchKeyEvent(import34.KeyEvent);
	@Import bool dispatchKeyShortcutEvent(import34.KeyEvent);
	@Import bool dispatchTouchEvent(import35.MotionEvent);
	@Import bool dispatchTrackballEvent(import35.MotionEvent);
	@Import bool dispatchGenericMotionEvent(import35.MotionEvent);
	@Import bool dispatchPopulateAccessibilityEvent(import37.AccessibilityEvent);
	@Import import1.View onCreatePanelView(int);
	@Import bool onCreatePanelMenu(int, import22.Menu);
	@Import bool onPreparePanel(int, import1.View, import22.Menu);
	@Import bool onMenuOpened(int, import22.Menu);
	@Import bool onMenuItemSelected(int, import38.MenuItem);
	@Import void onPanelClosed(int, import22.Menu);
	@Import void invalidateOptionsMenu();
	@Import bool onCreateOptionsMenu(import22.Menu);
	@Import bool onPrepareOptionsMenu(import22.Menu);
	@Import bool onOptionsItemSelected(import38.MenuItem);
	@Import bool onNavigateUp();
	@Import bool onNavigateUpFromChild(import7.Activity);
	@Import void onCreateNavigateUpTaskStack(import39.TaskStackBuilder);
	@Import void onPrepareNavigateUpTaskStack(import39.TaskStackBuilder);
	...
	@Import bool onContextItemSelected(import38.MenuItem);
	@Import void onContextMenuClosed(import22.Menu);
	...
	@Import void setFeatureDrawableUri(int, import28.Uri);
	...
	@Import void startActivityForResult(import5.Intent, int);
	@Import void startActivityForResult(import5.Intent, int, import12.Bundle);
	@Import bool isActivityTransitionRunning();
	@Import void startIntentSenderForResult(import44.IntentSender, int, import5.Intent, int, int, int);
	@Import void startIntentSenderForResult(import44.IntentSender, int, import5.Intent, int, int, int, import12.Bundle);
	@Import void startActivity(import5.Intent);
	@Import void startActivity(import5.Intent, import12.Bundle);
	@Import void startActivities(import5.Intent[]);
	@Import void startActivities(import5.Intent, import12.Bundle[]);
	@Import void startIntentSender(import44.IntentSender, import5.Intent, int, int, int);
	@Import void startIntentSender(import44.IntentSender, import5.Intent, int, int, int, import12.Bundle);
	@Import bool startActivityIfNeeded(import5.Intent, int);
	@Import bool startActivityIfNeeded(import5.Intent, int, import12.Bundle);
	@Import bool startNextMatchingActivity(import5.Intent);
	@Import bool startNextMatchingActivity(import5.Intent, import12.Bundle);
	@Import void startActivityFromChild(import7.Activity, import5.Intent, int);
	@Import void startActivityFromChild(import7.Activity, import5.Intent, int, import12.Bundle);
	@Import void startActivityFromFragment(import26.Fragment, import5.Intent, int);
	@Import void startActivityFromFragment(import26.Fragment, import5.Intent, int, import12.Bundle);
	@Import void startIntentSenderFromChild(import7.Activity, import44.IntentSender, int, import5.Intent, int, int, int);
	@Import void startIntentSenderFromChild(import7.Activity, import44.IntentSender, int, import5.Intent, int, int, int, import12.Bundle);
	@Import void overridePendingTransition(int, int);
	@Import void setResult(int);
	@Import void setResult(int, import5.Intent);
	@Import import28.Uri getReferrer();
	@Import import28.Uri onProvideReferrer();
	...
	@Import void finishFromChild(import7.Activity);
	@Import void finishAfterTransition();
	@Import void finishActivity(int);
	@Import void finishActivityFromChild(import7.Activity, int);
	@Import void finishAndRemoveTask();
	@Import bool releaseInstance();
	@Import void onActivityReenter(int, import5.Intent);
	@Import import46.PendingIntent createPendingResult(int, import5.Intent, int);
	...
	@Import void setTitle(import17.CharSequence);
	@Import void setTitle(int);
	@Import void setTitleColor(int);
	@Import import17.CharSequence getTitle();
	...
	@Import import1.View onCreateView(string, import51.Context, import52.AttributeSet);
	@Import import1.View onCreateView(import1.View, string, import51.Context, import52.AttributeSet);
	...
	@Import bool shouldUpRecreateTask(import5.Intent);
	@Import bool navigateUpTo(import5.Intent);
	@Import bool navigateUpToFromChild(import7.Activity, import5.Intent);
	@Import import5.Intent getParentActivityIntent();
	...
	@Import void applyOverrideConfiguration(import23.Configuration);
	...
	@Import void sendOrderedBroadcast(import5.Intent, string, import76.BroadcastReceiver, import77.Handler, int, string, import12.Bundle);
	@Import void sendBroadcastAsUser(import5.Intent, import78.UserHandle);
	@Import void sendBroadcastAsUser(import5.Intent, import78.UserHandle, string);
	@Import void sendOrderedBroadcastAsUser(import5.Intent, import78.UserHandle, string, import76.BroadcastReceiver, import77.Handler, int, string, import12.Bundle);
	@Import void sendStickyBroadcast(import5.Intent);
	@Import void sendStickyOrderedBroadcast(import5.Intent, import76.BroadcastReceiver, import77.Handler, int, string, import12.Bundle);
	@Import void removeStickyBroadcast(import5.Intent);
	@Import void sendStickyBroadcastAsUser(import5.Intent, import78.UserHandle);
	@Import void sendStickyOrderedBroadcastAsUser(import5.Intent, import78.UserHandle, import76.BroadcastReceiver, import77.Handler, int, string, import12.Bundle);
	@Import void removeStickyBroadcastAsUser(import5.Intent, import78.UserHandle);
	@Import import5.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter);
	@Import import5.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, int);
	@Import import5.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler);
	@Import import5.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler, int);
	@Import void unregisterReceiver(import76.BroadcastReceiver);
	@Import import45.ComponentName startService(import5.Intent);
	@Import import45.ComponentName startForegroundService(import5.Intent);
	@Import bool stopService(import5.Intent);
	@Import bool bindService(import5.Intent, import80.ServiceConnection, int);
	@Import bool bindService(import5.Intent, int, import66.Executor, import80.ServiceConnection);
	@Import bool bindIsolatedService(import5.Intent, int, string, import66.Executor, import80.ServiceConnection);
	...
	@Import void grantUriPermission(string, import28.Uri, int);
	@Import void revokeUriPermission(import28.Uri, int);
	@Import void revokeUriPermission(string, import28.Uri, int);
	@Import int checkUriPermission(import28.Uri, int, int, int);
	@Import int checkCallingUriPermission(import28.Uri, int);
	@Import int checkCallingOrSelfUriPermission(import28.Uri, int);
	@Import int checkUriPermission(import28.Uri, string, string, int, int, int);
	@Import void enforceUriPermission(import28.Uri, int, int, int, string);
	@Import void enforceCallingUriPermission(import28.Uri, int, string);
	@Import void enforceCallingOrSelfUriPermission(import28.Uri, int, string);
	@Import void enforceUriPermission(import28.Uri, string, string, int, int, int, string);
	@Import import51.Context createPackageContext(string, int);
	@Import import51.Context createContextForSplit(string);
	@Import import51.Context createConfigurationContext(import23.Configuration);
	...
	@Import import17.CharSequence getText(int);

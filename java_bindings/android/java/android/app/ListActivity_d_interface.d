...
import import5 = android.java.android.view.WindowManager_d_interface;
...
import import7 = android.java.android.app.LoaderManager_d_interface;
import import14 = android.java.android.graphics.Canvas_d_interface;
...
import import18 = android.java.java.util.function_.Consumer_d_interface;
...
import import17 = android.java.android.os.CancellationSignal_d_interface;
...
import import16 = android.java.android.app.assist.AssistContent_d_interface;
...
import import9 = android.java.android.app.Application_ActivityLifecycleCallbacks_d_interface;
...
import import19 = android.java.java.util.List_d_interface;
import import12 = android.java.android.app.VoiceInteractor_d_interface;
...
final class ListActivity : IJavaObject {
	...
	@Import bool isChild();
	@Import import4.Activity getParent();
	@Import import5.WindowManager getWindowManager();
	@Import import6.Window getWindow();
	@Import import7.LoaderManager getLoaderManager();
	@Import import8.View getCurrentFocus();
	@Import void registerActivityLifecycleCallbacks(import9.Application_ActivityLifecycleCallbacks);
	@Import void unregisterActivityLifecycleCallbacks(import9.Application_ActivityLifecycleCallbacks);
	@Import void onCreate(import10.Bundle, import11.PersistableBundle);
	@Import void onRestoreInstanceState(import10.Bundle, import11.PersistableBundle);
	@Import void onPostCreate(import10.Bundle, import11.PersistableBundle);
	...
	@Import import12.VoiceInteractor getVoiceInteractor();
	@Import bool isLocalVoiceInteractionSupported();
	@Import void startLocalVoiceInteraction(import10.Bundle);
	...
	@Import void onSaveInstanceState(import10.Bundle, import11.PersistableBundle);
	@Import bool onCreateThumbnail(import13.Bitmap, import14.Canvas);
	@Import import15.CharSequence onCreateDescription();
	@Import void onProvideAssistData(import10.Bundle);
	@Import void onProvideAssistContent(import16.AssistContent);
	@Import void onGetDirectActions(import17.CancellationSignal, import18.Consumer);
	@Import void onPerformDirectAction(string, import10.Bundle, import17.CancellationSignal, import18.Consumer);
	@Import void requestShowKeyboardShortcuts();
	@Import void dismissKeyboardShortcutsHelper();
	@Import void onProvideKeyboardShortcuts(import19.List, import20.Menu, int);
	@Import bool showAssist(import10.Bundle);
	...
	@Import void setContentView(import8.View, import29.ViewGroup_LayoutParams);
	@Import void addContentView(import8.View, import29.ViewGroup_LayoutParams);
	...
	@Import bool onNavigateUpFromChild(import4.Activity);
	...
	@Import void onCreateContextMenu(import38.ContextMenu, import8.View, import39.ContextMenu_ContextMenuInfo);
	...
	@Import bool showDialog(int, import10.Bundle);
	...
	@Import void startSearch(string, bool, import10.Bundle, bool);
	@Import void triggerSearch(string, import10.Bundle);
	...
	@Import void startActivityForResult(import2.Intent, int, import10.Bundle);
	@Import bool isActivityTransitionRunning();
	@Import void startIntentSenderForResult(import44.IntentSender, int, import2.Intent, int, int, int);
	@Import void startIntentSenderForResult(import44.IntentSender, int, import2.Intent, int, int, int, import10.Bundle);
	@Import void startActivity(import2.Intent);
	@Import void startActivity(import2.Intent, import10.Bundle);
	@Import void startActivities(import2.Intent[]);
	@Import void startActivities(import2.Intent, import10.Bundle[]);
	@Import void startIntentSender(import44.IntentSender, import2.Intent, int, int, int);
	@Import void startIntentSender(import44.IntentSender, import2.Intent, int, int, int, import10.Bundle);
	@Import bool startActivityIfNeeded(import2.Intent, int);
	@Import bool startActivityIfNeeded(import2.Intent, int, import10.Bundle);
	@Import bool startNextMatchingActivity(import2.Intent);
	@Import bool startNextMatchingActivity(import2.Intent, import10.Bundle);
	@Import void startActivityFromChild(import4.Activity, import2.Intent, int);
	@Import void startActivityFromChild(import4.Activity, import2.Intent, int, import10.Bundle);
	@Import void startActivityFromFragment(import24.Fragment, import2.Intent, int);
	@Import void startActivityFromFragment(import24.Fragment, import2.Intent, int, import10.Bundle);
	@Import void startIntentSenderFromChild(import4.Activity, import44.IntentSender, int, import2.Intent, int, int, int);
	@Import void startIntentSenderFromChild(import4.Activity, import44.IntentSender, int, import2.Intent, int, int, int, import10.Bundle);
	...
	@Import void finishFromChild(import4.Activity);
	@Import void finishAfterTransition();
	@Import void finishActivity(int);
	@Import void finishActivityFromChild(import4.Activity, int);
	@Import void finishAndRemoveTask();
	@Import bool releaseInstance();
	@Import void onActivityReenter(int, import2.Intent);
	@Import import46.PendingIntent createPendingResult(int, import2.Intent, int);
	...
	@Import import15.CharSequence getTitle();
	...
	@Import import8.View onCreateView(string, import51.Context, import52.AttributeSet);
	@Import import8.View onCreateView(import8.View, string, import51.Context, import52.AttributeSet);
	...
	@Import bool navigateUpToFromChild(import4.Activity, import2.Intent);
	...
	@Import void setWallpaper(import13.Bitmap);
	...
	@Import void sendOrderedBroadcast(import2.Intent, string, import76.BroadcastReceiver, import77.Handler, int, string, import10.Bundle);
	@Import void sendBroadcastAsUser(import2.Intent, import78.UserHandle);
	@Import void sendBroadcastAsUser(import2.Intent, import78.UserHandle, string);
	@Import void sendOrderedBroadcastAsUser(import2.Intent, import78.UserHandle, string, import76.BroadcastReceiver, import77.Handler, int, string, import10.Bundle);
	@Import void sendStickyBroadcast(import2.Intent);
	@Import void sendStickyOrderedBroadcast(import2.Intent, import76.BroadcastReceiver, import77.Handler, int, string, import10.Bundle);
	@Import void removeStickyBroadcast(import2.Intent);
	@Import void sendStickyBroadcastAsUser(import2.Intent, import78.UserHandle);
	@Import void sendStickyOrderedBroadcastAsUser(import2.Intent, import78.UserHandle, import76.BroadcastReceiver, import77.Handler, int, string, import10.Bundle);
	@Import void removeStickyBroadcastAsUser(import2.Intent, import78.UserHandle);
	@Import import2.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter);
	@Import import2.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, int);
	@Import import2.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler);
	@Import import2.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler, int);
	@Import void unregisterReceiver(import76.BroadcastReceiver);
	@Import import45.ComponentName startService(import2.Intent);
	@Import import45.ComponentName startForegroundService(import2.Intent);
	@Import bool stopService(import2.Intent);
	@Import bool bindService(import2.Intent, import80.ServiceConnection, int);
	@Import bool bindService(import2.Intent, int, import66.Executor, import80.ServiceConnection);
	@Import bool bindIsolatedService(import2.Intent, int, string, import66.Executor, import80.ServiceConnection);
	@Import void updateServiceGroup(import80.ServiceConnection, int, int);
	@Import void unbindService(import80.ServiceConnection);
	@Import bool startInstrumentation(import45.ComponentName, string, import10.Bundle);
	...
	@Import import15.CharSequence getText(int);

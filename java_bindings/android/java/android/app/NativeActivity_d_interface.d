...
final class NativeActivity : IJavaObject {
	...
	@Import bool isChild();
	@Import import5.Activity getParent();
	...
	@Import void onMultiWindowModeChanged(bool, import0.Configuration);
	@Import void onMultiWindowModeChanged(bool);
	@Import bool isInMultiWindowMode();
	@Import void onPictureInPictureModeChanged(bool, import0.Configuration);
	...
	@Import void setContentView(import9.View, import29.ViewGroup_LayoutParams);
	@Import void addContentView(import9.View, import29.ViewGroup_LayoutParams);
	...
	@Import bool onNavigateUpFromChild(import5.Activity);
	...
	@Import void onCreateContextMenu(import38.ContextMenu, import9.View, import39.ContextMenu_ContextMenuInfo);
	...
	@Import void startActivityForResult(import3.Intent, int);
	@Import void startActivityForResult(import3.Intent, int, import11.Bundle);
	@Import bool isActivityTransitionRunning();
	@Import void startIntentSenderForResult(import44.IntentSender, int, import3.Intent, int, int, int);
	@Import void startIntentSenderForResult(import44.IntentSender, int, import3.Intent, int, int, int, import11.Bundle);
	@Import void startActivity(import3.Intent);
	@Import void startActivity(import3.Intent, import11.Bundle);
	@Import void startActivities(import3.Intent[]);
	@Import void startActivities(import3.Intent, import11.Bundle[]);
	@Import void startIntentSender(import44.IntentSender, import3.Intent, int, int, int);
	@Import void startIntentSender(import44.IntentSender, import3.Intent, int, int, int, import11.Bundle);
	@Import bool startActivityIfNeeded(import3.Intent, int);
	@Import bool startActivityIfNeeded(import3.Intent, int, import11.Bundle);
	@Import bool startNextMatchingActivity(import3.Intent);
	@Import bool startNextMatchingActivity(import3.Intent, import11.Bundle);
	@Import void startActivityFromChild(import5.Activity, import3.Intent, int);
	@Import void startActivityFromChild(import5.Activity, import3.Intent, int, import11.Bundle);
	@Import void startActivityFromFragment(import24.Fragment, import3.Intent, int);
	@Import void startActivityFromFragment(import24.Fragment, import3.Intent, int, import11.Bundle);
	@Import void startIntentSenderFromChild(import5.Activity, import44.IntentSender, int, import3.Intent, int, int, int);
	@Import void startIntentSenderFromChild(import5.Activity, import44.IntentSender, int, import3.Intent, int, int, int, import11.Bundle);
	@Import void overridePendingTransition(int, int);
	@Import void setResult(int);
	@Import void setResult(int, import3.Intent);
	...
	@Import void finishFromChild(import5.Activity);
	@Import void finishAfterTransition();
	@Import void finishActivity(int);
	@Import void finishActivityFromChild(import5.Activity, int);
	@Import void finishAndRemoveTask();
	@Import bool releaseInstance();
	@Import void onActivityReenter(int, import3.Intent);
	@Import import46.PendingIntent createPendingResult(int, import3.Intent, int);
	...
	@Import import9.View onCreateView(string, import51.Context, import52.AttributeSet);
	@Import import9.View onCreateView(import9.View, string, import51.Context, import52.AttributeSet);
	...
	@Import bool shouldUpRecreateTask(import3.Intent);
	@Import bool navigateUpTo(import3.Intent);
	@Import bool navigateUpToFromChild(import5.Activity, import3.Intent);
	@Import import3.Intent getParentActivityIntent();
	...
	@Import void applyOverrideConfiguration(import0.Configuration);
	...
	@Import void sendOrderedBroadcast(import3.Intent, string, import76.BroadcastReceiver, import77.Handler, int, string, import11.Bundle);
	@Import void sendBroadcastAsUser(import3.Intent, import78.UserHandle);
	@Import void sendBroadcastAsUser(import3.Intent, import78.UserHandle, string);
	@Import void sendOrderedBroadcastAsUser(import3.Intent, import78.UserHandle, string, import76.BroadcastReceiver, import77.Handler, int, string, import11.Bundle);
	@Import void sendStickyBroadcast(import3.Intent);
	@Import void sendStickyOrderedBroadcast(import3.Intent, import76.BroadcastReceiver, import77.Handler, int, string, import11.Bundle);
	@Import void removeStickyBroadcast(import3.Intent);
	@Import void sendStickyBroadcastAsUser(import3.Intent, import78.UserHandle);
	@Import void sendStickyOrderedBroadcastAsUser(import3.Intent, import78.UserHandle, import76.BroadcastReceiver, import77.Handler, int, string, import11.Bundle);
	@Import void removeStickyBroadcastAsUser(import3.Intent, import78.UserHandle);
	@Import import3.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter);
	@Import import3.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, int);
	@Import import3.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler);
	@Import import3.Intent registerReceiver(import76.BroadcastReceiver, import79.IntentFilter, string, import77.Handler, int);
	@Import void unregisterReceiver(import76.BroadcastReceiver);
	@Import import45.ComponentName startService(import3.Intent);
	@Import import45.ComponentName startForegroundService(import3.Intent);
	@Import bool stopService(import3.Intent);
	@Import bool bindService(import3.Intent, import80.ServiceConnection, int);
	@Import bool bindService(import3.Intent, int, import66.Executor, import80.ServiceConnection);
	@Import bool bindIsolatedService(import3.Intent, int, string, import66.Executor, import80.ServiceConnection);
	@Import void updateServiceGroup(import80.ServiceConnection, int, int);
	@Import void unbindService(import80.ServiceConnection);
	@Import bool startInstrumentation(import45.ComponentName, string, import11.Bundle);
	...
	@Import import51.Context createConfigurationContext(import0.Configuration);
	...
	@Import void surfaceRedrawNeededAsync(import1.SurfaceHolder, import50.Runnable);

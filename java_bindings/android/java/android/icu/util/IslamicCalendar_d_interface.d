...
import import5 = android.java.android.icu.util.Calendar_d_interface;
import import6 = android.java.android.icu.text.DateFormat_d_interface;
import import7 = android.java.android.icu.util.Calendar_WeekData_d_interface;
...
final class IslamicCalendar : IJavaObject {
	...
	@Import static import5.Calendar getInstance(import2.ULocale);
	@Import static import5.Calendar getInstance(import0.TimeZone, import1.Locale);
	@Import static import5.Calendar getInstance(import0.TimeZone, import2.ULocale);
	...
	@Import bool isEquivalentTo(import5.Calendar);
	@Import int hashCode();
	...
	@Import import6.DateFormat getDateTimeFormat(int, int, import1.Locale);
	@Import import6.DateFormat getDateTimeFormat(int, int, import2.ULocale);

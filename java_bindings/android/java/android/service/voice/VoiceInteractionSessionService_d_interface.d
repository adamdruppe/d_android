...
final class VoiceInteractionSessionService : IJavaObject {
	...
	@Import void startActivity(import3.Intent, import1.Bundle);
	@Import void startActivities(import3.Intent[]);
	@Import void startActivities(import3.Intent, import1.Bundle[]);
	@Import void startIntentSender(import27.IntentSender, import3.Intent, int, int, int);
	@Import void startIntentSender(import27.IntentSender, import3.Intent, int, int, int, import1.Bundle);
	...
	@Import void sendOrderedBroadcast(import3.Intent, string, import28.BroadcastReceiver, import29.Handler, int, string, import1.Bundle);
	@Import void sendBroadcastAsUser(import3.Intent, import30.UserHandle);
	@Import void sendBroadcastAsUser(import3.Intent, import30.UserHandle, string);
	@Import void sendOrderedBroadcastAsUser(import3.Intent, import30.UserHandle, string, import28.BroadcastReceiver, import29.Handler, int, string, import1.Bundle);
	@Import void sendStickyBroadcast(import3.Intent);
	@Import void sendStickyOrderedBroadcast(import3.Intent, import28.BroadcastReceiver, import29.Handler, int, string, import1.Bundle);
	@Import void removeStickyBroadcast(import3.Intent);
	@Import void sendStickyBroadcastAsUser(import3.Intent, import30.UserHandle);
	@Import void sendStickyOrderedBroadcastAsUser(import3.Intent, import30.UserHandle, import28.BroadcastReceiver, import29.Handler, int, string, import1.Bundle);
	@Import void removeStickyBroadcastAsUser(import3.Intent, import30.UserHandle);
	@Import import3.Intent registerReceiver(import28.BroadcastReceiver, import31.IntentFilter);
	@Import import3.Intent registerReceiver(import28.BroadcastReceiver, import31.IntentFilter, int);
	@Import import3.Intent registerReceiver(import28.BroadcastReceiver, import31.IntentFilter, string, import29.Handler);
	@Import import3.Intent registerReceiver(import28.BroadcastReceiver, import31.IntentFilter, string, import29.Handler, int);
	@Import void unregisterReceiver(import28.BroadcastReceiver);
	@Import import32.ComponentName startService(import3.Intent);
	@Import import32.ComponentName startForegroundService(import3.Intent);
	@Import bool stopService(import3.Intent);
	@Import bool bindService(import3.Intent, import33.ServiceConnection, int);
	@Import bool bindService(import3.Intent, int, import13.Executor, import33.ServiceConnection);
	@Import bool bindIsolatedService(import3.Intent, int, string, import13.Executor, import33.ServiceConnection);
	@Import void updateServiceGroup(import33.ServiceConnection, int, int);
	@Import void unbindService(import33.ServiceConnection);
	@Import bool startInstrumentation(import32.ComponentName, string, import1.Bundle);
	...
	@Import import7.Context createConfigurationContext(import4.Configuration);

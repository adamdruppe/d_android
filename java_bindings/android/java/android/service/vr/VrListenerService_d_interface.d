...
final class VrListenerService : IJavaObject {
	...
	@Import import3.Context getBaseContext();
	...
	@Import bool moveSharedPreferencesFrom(import3.Context, string);
	...
	@Import bool moveDatabaseFrom(import3.Context, string);
	...
	@Import import2.ComponentName startService(import1.Intent);
	@Import import2.ComponentName startForegroundService(import1.Intent);
	@Import bool stopService(import1.Intent);
	@Import bool bindService(import1.Intent, import32.ServiceConnection, int);
	@Import bool bindService(import1.Intent, int, import12.Executor, import32.ServiceConnection);
	@Import bool bindIsolatedService(import1.Intent, int, string, import12.Executor, import32.ServiceConnection);
	@Import void updateServiceGroup(import32.ServiceConnection, int, int);
	@Import void unbindService(import32.ServiceConnection);
	@Import bool startInstrumentation(import2.ComponentName, string, import26.Bundle);
	...
	@Import import3.Context createPackageContext(string, int);
	@Import import3.Context createContextForSplit(string);
	@Import import3.Context createConfigurationContext(import5.Configuration);
	@Import import3.Context createDisplayContext(import35.Display);
	@Import bool isRestricted();
	@Import import3.Context createDeviceProtectedStorageContext();

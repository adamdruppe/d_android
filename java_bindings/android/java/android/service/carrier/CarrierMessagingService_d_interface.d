...
final class CarrierMessagingService : IJavaObject {
	...
	@Import void startActivity(import5.Intent, import29.Bundle);
	@Import void startActivities(import5.Intent[]);
	@Import void startActivities(import5.Intent, import29.Bundle[]);
	@Import void startIntentSender(import30.IntentSender, import5.Intent, int, int, int);
	@Import void startIntentSender(import30.IntentSender, import5.Intent, int, int, int, import29.Bundle);
	...
	@Import void sendOrderedBroadcast(import5.Intent, string, import31.BroadcastReceiver, import32.Handler, int, string, import29.Bundle);
	@Import void sendBroadcastAsUser(import5.Intent, import33.UserHandle);
	@Import void sendBroadcastAsUser(import5.Intent, import33.UserHandle, string);
	@Import void sendOrderedBroadcastAsUser(import5.Intent, import33.UserHandle, string, import31.BroadcastReceiver, import32.Handler, int, string, import29.Bundle);
	@Import void sendStickyBroadcast(import5.Intent);
	@Import void sendStickyOrderedBroadcast(import5.Intent, import31.BroadcastReceiver, import32.Handler, int, string, import29.Bundle);
	@Import void removeStickyBroadcast(import5.Intent);
	@Import void sendStickyBroadcastAsUser(import5.Intent, import33.UserHandle);
	@Import void sendStickyOrderedBroadcastAsUser(import5.Intent, import33.UserHandle, import31.BroadcastReceiver, import32.Handler, int, string, import29.Bundle);
	@Import void removeStickyBroadcastAsUser(import5.Intent, import33.UserHandle);
	@Import import5.Intent registerReceiver(import31.BroadcastReceiver, import34.IntentFilter);
	@Import import5.Intent registerReceiver(import31.BroadcastReceiver, import34.IntentFilter, int);
	@Import import5.Intent registerReceiver(import31.BroadcastReceiver, import34.IntentFilter, string, import32.Handler);
	@Import import5.Intent registerReceiver(import31.BroadcastReceiver, import34.IntentFilter, string, import32.Handler, int);
	@Import void unregisterReceiver(import31.BroadcastReceiver);
	@Import import35.ComponentName startService(import5.Intent);
	@Import import35.ComponentName startForegroundService(import5.Intent);
	@Import bool stopService(import5.Intent);
	@Import bool bindService(import5.Intent, import36.ServiceConnection, int);
	@Import bool bindService(import5.Intent, int, import15.Executor, import36.ServiceConnection);
	@Import bool bindIsolatedService(import5.Intent, int, string, import15.Executor, import36.ServiceConnection);
	...
	@Import void grantUriPermission(string, import3.Uri, int);
	@Import void revokeUriPermission(import3.Uri, int);
	@Import void revokeUriPermission(string, import3.Uri, int);
	@Import int checkUriPermission(import3.Uri, int, int, int);
	@Import int checkCallingUriPermission(import3.Uri, int);
	@Import int checkCallingOrSelfUriPermission(import3.Uri, int);
	@Import int checkUriPermission(import3.Uri, string, string, int, int, int);
	@Import void enforceUriPermission(import3.Uri, int, int, int, string);
	@Import void enforceCallingUriPermission(import3.Uri, int, string);
	@Import void enforceCallingOrSelfUriPermission(import3.Uri, int, string);
	@Import void enforceUriPermission(import3.Uri, string, string, int, int, int, string);
	...
	@Import import9.Context createDisplayContext(import38.Display);

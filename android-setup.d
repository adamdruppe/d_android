...
int main(string[] args) {
	...
	if(args.length < 2) {
		version(Windows)
			string example = r"C:\Users\PC\AppData\Local\Android\Sdk\ndk\21.0.6113669";
		else
			string example = "/home/me/Android/ndk/android-ndk-r20/";

		writeln("Please specify the path to your NDK installation on the command line. It should be an absolute path, for example: ", example);
		writeln("Tip: if you are using `dub run`, use `dub run d_android:setup -- your_path_here`");
		return 1;
	} 
...
See more info here: https://github.com/ldc-developers/ldc#installation");
	...
	*/
	...
	writefln("Downloading Android runtimes... (about 50 MB total, may take a while)");
	...
	// e.g.
	// https://github.com/ldc-developers/ldc/releases/download/v1.21.0-beta1/ldc2-1.21.0-beta1-android-armv7a.tar.xz
	// https://github.com/ldc-developers/ldc/releases/download/v1.21.0-beta1/ldc2-1.21.0-beta1-android-aarch64.tar.xz


/+

16 files! this is just half the examples
...
we want it. then just need to identify the target and put it in the right place.
...
ldc2-1.19.0-android-armv7a/lib/libphobos2-ldc.a
ldc2-1.19.0-android-armv7a/lib/libphobos2-ldc-debug.a
ldc2-1.19.0-android-armv7a/lib-i686/libphobos2-ldc.a
ldc2-1.19.0-android-armv7a/lib-i686/libphobos2-ldc-debug.a

ldc2-1.19.0-android-aarch64/lib-x86_64/libdruntime-ldc-debug.a
ldc2-1.19.0-android-aarch64/lib-x86_64/libdruntime-ldc.a
ldc2-1.19.0-android-aarch64/lib/libdruntime-ldc-debug.a
ldc2-1.19.0-android-aarch64/lib/libdruntime-ldc.a
+/


	doDownload("https://github.com/ldc-developers/ldc/releases/download/v" ~ ldcVersion ~ "/ldc2-" ~ ldcVersion ~ "-android-armv7a.tar.xz", &handleChunk);
	xzd = XzDecoder.init;
	doDownload("https://github.com/ldc-developers/ldc/releases/download/v" ~ ldcVersion ~ "/ldc2-" ~ ldcVersion ~ "-android-aarch64.tar.xz", &handleChunk);
...
"armv7a-.*-linux-android":
{
    ...
    lib-dirs = [
        "$D_ANDROID/ldc2-$LDC_VERSION-android-armv7a/lib",
    ];
    rpath = "";
};
...
"aarch64-.*-linux-android":
{
    ...
    lib-dirs = [
        "$D_ANDROID/ldc2-$LDC_VERSION-android-aarch64/lib/",
    ];
    rpath = "";
};
...
"i386-.*-linux-android":
{
    ...
    lib-dirs = [
        "$D_ANDROID/ldc2-$LDC_VERSION-android-armv7a/lib-i686/",
    ];
    rpath = "";
};
...
"x86_64-.*-linux-android":
{
    ...
    lib-dirs = [
        "$D_ANDROID/ldc2-$LDC_VERSION-android-aarch64/lib-x86_64",
    ];
    rpath = "";
};

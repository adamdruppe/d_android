module android.ndk.camera.NdkCameraCaptureSession;
 ...
 */
alias ACameraCaptureSession_stateCallback = void function (void* context, ACameraCaptureSession* session);
 ...
 */
alias ACameraCaptureSession_captureCallback_start = void function (
    void* context,
 ...
 */
alias ACameraCaptureSession_captureCallback_result = void function (
    void* context,
    ACameraCaptureSession* session,
 ...
 *                returns.
 */
alias ACameraCaptureSession_captureCallback_failed = void function (
    void* context,
    ACameraCaptureSession* session,
    ACaptureRequest* request,
 ...
 */
alias ACameraCaptureSession_captureCallback_sequenceEnd = void function (
    void* context,
    ACameraCaptureSession* session,
    int sequenceId,
    long frameNumber);
 ...
 */
alias ACameraCaptureSession_captureCallback_sequenceAbort = void function (
    void* context,
    ACameraCaptureSession* session,
    int sequenceId);
 ...
 */
alias ACameraCaptureSession_captureCallback_bufferLost = void function (
    void* context,
    ACameraCaptureSession* session,
    ACaptureRequest* request,
 ...
 */
alias ACameraCaptureSession_logicalCamera_captureCallback_result = void function (
    void* context,
    ACameraCaptureSession* session,
    ACaptureRequest* request,
    const(ACameraMetadata)* result,
...
struct ALogicalCameraCaptureFailure
{
     ...
     * failure.
     */
    ACameraCaptureFailure captureFailure;
 ...
 *                returns.
 */
alias ACameraCaptureSession_logicalCamera_captureCallback_failed = void function (
    void* context,
    ACameraCaptureSession* session,
    ACaptureRequest* request,

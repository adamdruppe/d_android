 ...
 */
module android.ndk.media.NdkImage;
...
alias AIMAGE_FORMAT_RGBA_8888 = AIMAGE_FORMATS.rgba8888;
alias AIMAGE_FORMAT_RGBX_8888 = AIMAGE_FORMATS.rgbx8888;
alias AIMAGE_FORMAT_RGB_888 = AIMAGE_FORMATS.rgb888;
alias AIMAGE_FORMAT_RGB_565 = AIMAGE_FORMATS.rgb565;
alias AIMAGE_FORMAT_RGBA_FP16 = AIMAGE_FORMATS.rgbaFp16;
alias AIMAGE_FORMAT_YUV_420_888 = AIMAGE_FORMATS.yuv420888;
alias AIMAGE_FORMAT_JPEG = AIMAGE_FORMATS.jpeg;
alias AIMAGE_FORMAT_RAW16 = AIMAGE_FORMATS.raw16;
alias AIMAGE_FORMAT_RAW_PRIVATE = AIMAGE_FORMATS.rawPrivate;
alias AIMAGE_FORMAT_RAW10 = AIMAGE_FORMATS.raw10;
alias AIMAGE_FORMAT_RAW12 = AIMAGE_FORMATS.raw12;
alias AIMAGE_FORMAT_DEPTH16 = AIMAGE_FORMATS.depth16;
alias AIMAGE_FORMAT_DEPTH_POINT_CLOUD = AIMAGE_FORMATS.depthPointCloud;
alias AIMAGE_FORMAT_PRIVATE = AIMAGE_FORMATS.private_;
alias AIMAGE_FORMAT_Y8 = AIMAGE_FORMATS.y8;
alias AIMAGE_FORMAT_HEIC = AIMAGE_FORMATS.heic;
alias AIMAGE_FORMAT_DEPTH_JPEG = AIMAGE_FORMATS.depthJpeg;
 ...
 */
/*out*/
media_status_t AImage_getWidth (const(AImage)* image, int* width);
 ...
 */
/*out*/
media_status_t AImage_getHeight (const(AImage)* image, int* height);
 ...
 */
/*out*/
media_status_t AImage_getFormat (const(AImage)* image, int* format);
 ...
 */
/*out*/
media_status_t AImage_getTimestamp (const(AImage)* image, long* timestampNs);
 ...
 */
/*out*/
media_status_t AImage_getNumberOfPlanes (const(AImage)* image, int* numPlanes);

 ...
 */
module android.ndk.media.NdkImageReader;

import
    android.ndk.media.NdkMediaError,
    android.ndk.media.NdkImage,
 ...
 */
/*out*/
media_status_t AImageReader_getWidth (const(AImageReader)* reader, int* width);
 ...
 */
/*out*/
media_status_t AImageReader_getHeight (const(AImageReader)* reader, int* height);
 ...
 */
/*out*/
media_status_t AImageReader_getFormat (const(AImageReader)* reader, int* format);
 ...
 */
/*out*/
media_status_t AImageReader_getMaxImages (const(AImageReader)* reader, int* maxImages);
 ...
 */
alias AImageReader_ImageCallback = void function (void* context, AImageReader* reader);
 ...
 */
alias AImageReader_BufferRemovedCallback = void function (
    void* context,
    AImageReader* reader,
